...
namespace APIVerve\Cardvalidator;
...
/**
 * Client for the Card Validator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/cardvalidator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/cardvalidator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CardvalidatorClient] {$message}\n";
        }
    }
}
