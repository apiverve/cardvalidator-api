# Card Validator API - Examples

This folder contains example code for using the Card Validator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/cardvalidator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/cardvalidator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/cardvalidator](https://docs.apiverve.com/ref/cardvalidator)
