// Package cardvalidator provides a Go client for the Card Validator API.
//
// For more information, visit: https://apiverve.com/marketplace/cardvalidator?utm_source=go&utm_medium=readme
...
// Request contains the parameters for the Card Validator API.
//
// Parameters:
//   - number (required): string - The card number to validate [minLength: 13, maxLength: 19]
type Request struct {
...
func (r *Request) Validate() error {
	rules := map[string]ValidationRule{
		"number": {Type: "string", Required: true, MinLength: intPtr(13), MaxLength: intPtr(19)},
	}
...
// ResponseData contains the data returned by the Card Validator API.
...
// CardData represents the card object.
type CardData struct {
	NiceType string `json:"niceType"`
	Type string `json:"type"`
	Patterns []int `json:"patterns"`
	Gaps []int `json:"gaps"`
	Lengths []int `json:"lengths"`
	Code CodeData `json:"code"`
	MatchStrength int `json:"matchStrength"`
}

// CodeData represents the code object.
