/*
 * Card Validator API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Card Validator API.
 * API Documentation: https://docs.apiverve.com/ref/cardvalidator
 */
...
{
    class CardValidatorExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/cardvalidator";

        /// <summary>
        /// Make a GET request to the Card Validator API
        /// </summary>
        static async Task<JsonDocument> CallCardValidatorAPI()
        {
            try
            {
                ...
                // Query parameters
                var queryParams &#x3D; new Dictionary&lt;string, string&gt; { [&quot;number&quot;] &#x3D; &quot;4900264223817524&quot; };
        ...
        {
            Console.WriteLine("📤 Calling Card Validator API...\n");

            var result = await CallCardValidatorAPI();
