...
const (
	baseURL        = "https://api.apiverve.com/v1/cardvalidator"
	defaultTimeout = 30 * time.Second
)

// Client is the Card Validator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Card Validator API client.
...
// Execute makes a request to the Card Validator API with typed parameters.
//
