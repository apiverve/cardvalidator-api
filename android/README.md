...
```gradle
dependencies {
    implementation 'com.github.apiverve:cardvalidator-api:1.1.13'
}
```
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/cardvalidator](https://docs.apiverve.com/ref/cardvalidator)
...
- **Documentation:** [https://docs.apiverve.com/ref/cardvalidator](https://docs.apiverve.com/ref/cardvalidator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/cardvalidator-api/issues)
