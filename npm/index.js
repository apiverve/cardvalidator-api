...
class cardvalidatorWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/cardvalidator');
        }
        ...
        this.validationRules = {"number":{"type":"string","required":true,"minLength":13,"maxLength":19}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/cardvalidator`);
        }
    }
...
module.exports = cardvalidatorWrapper;
